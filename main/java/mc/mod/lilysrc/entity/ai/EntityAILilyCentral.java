package mc.mod.lilysrc.entity.ai;

import java.util.HashMap;
import java.util.Iterator;

import mc.mod.lilysrc.MainRegistry;
import mc.mod.lilysrc.entity.BlockEvent;
import mc.mod.lilysrc.entity.ai.basic.EntityAILookAround;
import mc.mod.lilysrc.entity.ai.decision.Decisor;
import mc.mod.lilysrc.entity.ai.decision.DecisorFactory;
import mc.mod.lilysrc.entity.ai.decision.tree.TreeDecisor;
import mc.mod.lilysrc.entity.ai.enumerations.EntityDistance;
import mc.mod.lilysrc.entity.ai.enumerations.TimerLeft;
...
import mc.mod.lilysrc.match.PlayerDefeatHandler;
import mc.mod.lilysrc.reasoning.HearingHandler;
import mc.mod.lilysrc.reasoning.SightHandler;
