package mc.mod.lilysrc.reasoning;
...
public class SightHandler {
	...
	public EntityDistance checkPlayerInSight(Entity player,
		...
		// determines if Lily can see the player by checking whether
		// there are blocks between them
		if (this.isInFieldOfVision(player, (EntityLiving)entity)) {

			// checks if the player is invisible because of 
