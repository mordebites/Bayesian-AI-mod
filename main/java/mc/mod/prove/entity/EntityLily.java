...
public class EntityLily extends EntityCreature {
	...
	public static void createEntity(Class entityClass, String entityName,
		...
		EntityRegistry.registerModEntity(entityClass, entityName, 1, MainRegistry.modInstance, 80, 1, false);
	...
	private static void createEgg(int id, int solidColor, int spotColor){
		EntityList.entityEggs.put(String.valueOf(id), new EntityList.EntityEggInfo(String.valueOf(id), solidColor, spotColor));
	}
}
