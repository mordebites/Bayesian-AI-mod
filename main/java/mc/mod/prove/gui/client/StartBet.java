...
public class StartBet extends GuiScreen {
	...
	public void initGui() {
		...
		this.texter = new GuiTextField(0, this.fontRendererObj, centered_width - 70, centered_height - 60, 150, 20);
        texter.setMaxStringLength(60);
        texter.setText("Hey there! Let's battle!!11");
        this.texter.setFocused(true);
				
		this.buttonList.add(this.a = new GuiButton(0, centered_width - 100, centered_height - 24, "Yes"));
	    this.buttonList.add(this.b = new GuiButton(1, centered_width - 100, centered_height + 4, "Nope"));
	}
